...
const pt: ChatDict = {
  ...
  mangrove: {
    ...
    publishedTitle: "Publicado por voce e seu agente",
    ...
    scopePrivate: "Somente voce",
    scopePeople: "Pessoas",
    scopePrivateNote: "Ninguem mais ve. Seu agente continua podendo ler.",
    scopePeopleNote: "Cada pessoa decide se deixa entrar na memoria do agente dela.",
