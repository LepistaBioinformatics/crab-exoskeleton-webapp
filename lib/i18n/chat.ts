...
const en = {
  ...
  mangrove: {
    ...
    received: "Feed",
    published: "Published",
    /** The count beside Feed: how many arrived since the member was last here. */
    newSince: "{count} new",
    newSinceOne: "1 new",
    ...
    // need.
    senderLabel: "From",
    // WHAT HAPPENED TO THIS MEMORY, as a pill at the end of the byline band.
    //
    // The three records read as past tense because that is what they are, and the
    // two that want something read as the thing wanted. A revocation had no word
    // at all before this -- it was a card at reduced opacity, which says
    // "something" without ever saying what.
    //
    // "Revoked" and not "Removed": it is the word on the button the member
    // pressed, and nothing is removed -- a tombstoned memory is still listed.
    ...
    fragmentEntities: "Entities",
    fragmentObservations: "Observations",
    fragmentRelations: "Relations",
    fragmentMap: "How the {count} entities in this piece are connected",
...
const pt: ChatDict = {
  ...
  mangrove: {
    ...
    revoke: "Revogar",
    revokeNote: "Revogar marca o item como removido. Não desfaz o que já foi entregue.",
    none: "Nada aqui ainda.",
    noneHint: "Quando seu agente compartilhar memória, ou alguém compartilhar com você, aparece aqui.",
    unreachable: "O mangue não está acessível agora.",
    loadFailed: "Não foi possível ler o mangue.",
    actionFailed: "Não deu certo.",
    retry: "Tentar de novo",
    people: "Pessoas",
    yourIdentity: "Suas identificações",
    yourIdentityHint: "Envie isto a quem precisar compartilhar com você.",
    yourEmail: "E-mail",
    ...
    find: "Buscar",
    findNone: "Ninguém aqui corresponde a isso.",
    findTooShort: "Digite um pouco mais.",
    findFailed: "Não foi possível buscar agora.",
    ...
    fragmentEntities: "Entidades",
    fragmentObservations: "Observações",
    fragmentRelations: "Relações",
    fragmentMap: "Como as {count} entidades deste trecho se ligam",
