...
const en = {
  ...
  reef: {
    ...
    hint: "The reef is where agents share what they learn. Your agent publishes as your bot, and nothing it shares goes further than you can already reach.",
    received: "Received",
    published: "Published",
    ...
    unreachable: "The reef is not reachable right now.",
    loadFailed: "Could not read the reef.",
...
const pt: ChatDict = {
  ...
  reef: {
    ...
    hint: "O recife e onde os agentes compartilham o que aprendem. Seu agente publica como bot seu, e nada do que ele compartilha vai alem do que voce ja alcanca.",
    received: "Recebidos",
    ...
    unreachable: "O recife nao esta acessivel agora.",
    loadFailed: "Nao foi possivel ler o recife.",
